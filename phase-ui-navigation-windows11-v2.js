(function(){
  ...
  function apply(){
    ...
    style.textContent=`
      ...
      .mi-module-nav > button.mi-module-btn .mi-module-label{
      ...
      @media (max-width:900px){
        .mi-module-nav{grid-template-columns:repeat(3,minmax(0,1fr)) !important}
        .mi-module-nav > button.mi-module-btn:nth-child(6){grid-column:auto}
        .mi-module-nav > button.mi-module-btn:nth-child(n+6){grid-row:auto}
      }
      @media (max-width:560px){
        .mi-module-nav{grid-template-columns:repeat(2,minmax(0,1fr)) !important}
      }
    `;
    document.head.appendChild(style);
    nav.setAttribute('data-nav-layout','two-row');
    NAV.forEach(id=>{const b=document.getElementById(id);if(b){b.style.whiteSpace='normal';b.style.overflow='visible';b.style.textOverflow='clip'}});
  }
